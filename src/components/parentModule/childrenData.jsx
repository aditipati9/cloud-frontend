...
function ChildrenData() {
  ...
  const getChildDataService = () => {
    try {
      axios({
        method: "GET",
        url: `http://127.0.0.1:5000/parent/get_children_details/hardik@gmail.com`,
        headers: {
          "Content-role": "application/json",
        },
      }).then((response) => {
        setChildData(response.data.children_details);
        setLoadChildDataList(false);
      });
    } catch (err) {
  ...
  const addChildDataService = () => {
    try {
      axios({
        ...
        url: `http://127.0.0.1:5000/parent/add_child/hardik@gmail.com`,
        headers: {
          "Content-role": "application/json",
        },
      }).then((response) => {
        notifySuccess("Car Added Successfully","top-right");
        getChildDataService();
        setAddNewChildData({});
      });
    } catch (err) {
  ...
  const editChildDataService = (id) => {
    ...
    try {
      axios({
        method: "POST",
        data: editChildData,
        url: `http://127.0.0.1:5000/parent/update_child/hardik@gmail.com/${id}`,
        headers: {
          "Content-role": "application/json",
        },
      }).then((response) => {
        console.log(response);
        notifySuccess("Data Updated Successfully","top-right");
        getChildDataService();
        setEditChildData({});
      });
    } catch (err) {
  ...
  const deleteChildDataService = () => {
    try {
      axios({
        ...
        notifySuccess("Car Deleted Successfully","top-right");
        getChildDataService();
      });
    } catch (err) {
        ...
        <div class=" px-10 flex items-center  justify-between bg-[#333333] text-[#FFFFFF]">
          ...
          <div class="flex">
            ...
            {showForm ? (
              ...
              <div>
                  <button class=" text-dark-200 hover:text-[#AEFFDE] focus:text-gray-600 rounded-full mt-5" onClick={handleLogOut}>
          ...
          <div>
            <div className=" p-5 flex justify-center bg-childData">
              <form class=" flex flex-col gap-2 bg-900 p-10 w-1/2 align-middle justify-center rounded-md" onSubmit={handleAddAndEditChild}>
                ...
                <div>
                  <label class="block text-gray-100">Model</label>
                  <input
                    type="text"
                ...
                <div>
                  <label class="block text-gray-100">Date Of Admission</label>
                  <input
                    type="date"
                ...
                <div>
                  <label class="block text-gray-100">Transmission</label>
                  <Select
                    autofocus
                                    ...
                                    <div class="md:flex items-center">
                                      ...
                                      <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
                                        ...
                                        <p class="text-sm text-gray-700 mt-1">
                                          You will lose car data by deleting
