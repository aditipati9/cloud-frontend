      ...
      <div>
        ...
        >
            ...
            >
              <div class="text-sm font-medium mt-6 lg:flex-grow font-sans flex gap-10 justify-end">
                ...
                <div className="btnDiv cursor-pointer">
                  <a
                    onClick={handleNavClick}
                    id="adminChildrenData"
                    className="block mt-1 lg:inline-block lg:mt-0 text-dark-200 hover:text-[#AEFFDE]"
                  >
                    View Child Data
                  </a>
                </div>
          ...
          <div
            ...
            style={{
              "background-image":
                "url('https://plus.unsplash.com/premium_photo-1664297989345-f4ff2063b212?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8c2VydmVyfGVufDB8fDB8fHww')",
            }}
          >
              ...
              <div class="flex flex-wrap items-center md:justify-between justify-center">
                <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                  <div class="text-sm text-blueGray-500 font-semibold py-1">
                    ...
                    />{" "}
                    Created By
                    <a class="text-blueGray-500 hover:text-blueGray-800">
                      Team-2
                    </a>
                    .
                  </div>
